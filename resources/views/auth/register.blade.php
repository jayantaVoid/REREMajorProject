                        ...
                        <div class="login-right-wrap">
                            ...
                            <form action="{{ route('registration') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control pass-input @error('password') is-invalid @enderror" type="password" id="password" name="password">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control pass-confirm" type="text" id="password-confirm" name="password_confirmation">
