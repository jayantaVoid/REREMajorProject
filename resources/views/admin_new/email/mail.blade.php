...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../"/>
		<title>PreSkool - Welcome Mail</title>
		<meta charset="utf-8" />
								...
								<tbody>
											...
											<div style="text-align:center; margin:0 15px 34px 15px">
												...
												<div style="margin-bottom: 10px">
													<a href="https://keenthemes.com" rel="noopener" target="_blank">
														<img alt="Logo" src="assets/img/logo.png" style="height: 35px" />
													</a>
												</div>
												<!--end:Logo-->
												<!--begin:Media-->
											...
											<div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
												...
												<div style="display:flex">
													...
													<div>
														...
														<div>
															<!--begin::Title-->
															<a href="#" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Give Exam</a>
															<!--end::Title-->
															<!--begin::Desc-->
												...
												<div style="display:flex">
													...
													<div>
														...
														<div>
															<!--begin::Title-->
															<a href="#" style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Get Badges</a>
															<!--end::Title-->
															<!--begin::Desc-->
									...
									<tr>
										<td align="center" valign="center" style="font-size: 13px; text-align:center; padding: 0 10px 10px 10px; font-weight: 500; color: #A1A5B7; font-family:Arial,Helvetica,sans-serif">
											<p style="color:#181C32; font-size: 16px; font-weight: 600; margin-bottom:9px">It’s all about Yours!</p>
