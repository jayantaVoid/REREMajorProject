    ...
    <ul class="nav user-menu">
                    ...
                    <ul class="notification-list">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media d-flex">
                                    <span class="avatar avatar-sm flex-shrink-0">
                                        <img class="{{ asset('avatar-img rounded-circle') }}" alt="User Image"
        ...
        <li class="nav-item dropdown has-arrow new-user-menus">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle" src="{{ (!empty(auth()->user()->profile()->first()->picture)) ? asset('assets/img/' . auth()->user()->profile()->first()->picture) : '' }}" width="31">
                    <div class="user-text">
            ...
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm">
                        <img src="{{ (!empty(auth()->user()->profile()->first()->picture)) ? asset('assets/img/' . auth()->user()->profile()->first()->picture) : ''}}"
